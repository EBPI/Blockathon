...
import ebpi.hackathon.hypertrace.web.domein.*;
...
public class HyperledgerRestService {
    ...
    private static final String ACCEPT_HANDOVER_PARAM = "acceptHandover";
    ...
    public void startHandoverReceiver(Handover handover) {
        try {
            URI url;
