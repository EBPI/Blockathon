...
nohup composer-rest-server --port 3001 -c Nike@hypertrace -n always -w true &
...
nohup composer-rest-server --port 3004 -c Douane59488016@hypertrace -n always -w true &
